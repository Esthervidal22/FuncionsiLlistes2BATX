...
def introduce_total_alumnos():
	total=raw_input(input("Introduce el número total de alumnos: "))
...
def introduce_nombre_alumno(num_alumno,lista_nombres_alumnos):
	...
	while i<(lenlista_nombres_alumnos)):
...
def introduce_nota_alumno(num_alumno):
	i=0
	nota_alumno=raw_input(input("Introduce la nota del alumno: "))
